...
//        Log.d("RECIPE", Arrays.toString(items.toArray()));
        ...
        List<RecipeModel> dbListItems = databaseHelper.getRecipeData();
//        databaseHelper.dropTable();

        for(RecipeModel recipeModel : items){
            databaseHelper.insertRecipeData(recipeModel.getName(), recipeModel.getImageUrl(), recipeModel.getInstructions());
        }
